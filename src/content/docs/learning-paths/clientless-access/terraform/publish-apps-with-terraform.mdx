...
Users can now access the private application by going to the public URL and authenticating with Cloudflare Access. You can view your new tunnel route in the [Cloudflare dashboard](https://dash.cloudflare.com/) under **Networking** > **Tunnels**, and your Access application and policy under **Zero Trust** > **Access controls** > **Applications**. The new DNS record is shown in the [Cloudflare dashboard](https://dash.cloudflare.com/).
