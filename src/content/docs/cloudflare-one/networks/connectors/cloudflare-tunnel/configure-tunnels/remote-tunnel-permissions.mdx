...
2. Select a `cloudflared` tunnel to open its detail page.
3. On the **Overview** tab, copy the `cloudflared` installation command into a text editor (do not run the command). The token is the `eyJ...` string.
