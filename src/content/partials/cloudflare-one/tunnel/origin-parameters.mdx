...
2. Select a tunnel, then go to the **Routes** tab.
3. Find the published application you want to modify and select **Edit**.
4. Under **Additional application settings**, modify one or more origin parameters.
5. Select **Save**.
